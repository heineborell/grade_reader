...
\begin{picture}(-2.0,1.5)(-2.0,1.5)
  ...
  \put(-.5,1.5){\line(1,0){10.95}}  \put(-.5,1.5){\line(0,1){5.1}}
  \put(13.5,2.5){\line(0,1){4.1}}\put(4.0,2.5){\line(0,1){3.1}}
  \put(4.0,3.5){\line(1,0){9.5}}
  ...
  %                                                                 %
  \put(1.8,5.25){\mkbx{{\em Bs105a}}}                              %
  \put(1.8,4.8){\mkbx {{\em 2025}}}                            %
  \put(1.8,4.35){\mkbx{{\em Fall}}}                                 %
  \put(1.8,3.8){\mkbx {{\em 17.10.2025}}}                           %
  \put(1.8,3.35){\mkbx{{\em 18:30}}}                               %
  \put(1.8,2.8){\mkbx {{\em 120 min }}}                             %
  %                                                                 %
  \put(9.25,3.2){\makebox(0,0)[c]{2 PARTS ON 6 PAGES}}          %
  %                                                                 %
...
\vspace{0.13cm}
% \hspace*{9.81cm}\includegraphics[width=1cm,height=1cm]{aruco.pdf}
% \begin{center}
  ...
  \fbox{\fbox{\parbox{5.5in}{\centering
        ...
        \begin{itemize}
          \item You have 120 minutes to complete this exam. This
            question booklet contains 6 pages (including the cover)
